 ...
 */
public class CareerPathFragment extends Fragment {

Button psycho;
    public CareerPathFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_career_path, container, false);
        psycho=view.findViewById(R.id.psycho);
